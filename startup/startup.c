...
/* extern means that its defined somewhere else and that compiler should look for their definition elsewhere, no mem allocated here*/
...
/* Vector Table */
/* Array of 32 bit addresses : Like an address book for the CPU to know where to jump to. Array of function pointers. */
uint32_t vector_tbl[] __attribute__((section(".isr_vector_table")))={
